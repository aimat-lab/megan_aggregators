...
for which the counterfactuals are generated. That molecule being "Aspirin".
Aspirin is an existing drug and a known non-aggregator which means that the counterfactuals are
supposed to flip the label to aggregator.
"""
