...
# :param CSV_FILE_NAME: 
#       This has to be the absolute string path to the CSV file that contains the actual dataset
#       which has to have specific format to that it can be correctly processed.
CSV_FILE_NAME: str = os.path.join(ASSETS_PATH, 'aggregators_binary_protonated.csv')
