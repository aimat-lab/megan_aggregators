...
VISUAL_GRAPH_DATASET: str = os.path.join(EXPERIMENTS_PATH, 'assets', 'cache', 'antibiotics', 'all')
...
MODEL_PATH: str = os.path.join(EXPERIMENTS_PATH, 'results', 'vgd_torch_chunked_megan__antibiotics', '007_with_contrastive', 'model_best.ckpt')
...
CHANNEL_INFOS: t.Dict[int, dict] = {
    0: {'name': 'inactive', 'color': '#FF7B2F'},
    1: {'name': 'active', 'color': '#3EFFAF'},
}
